#ifndef COHEN_ENGINE_MAGIC_HPP_INCLUDED
#define COHEN_ENGINE_MAGIC_HPP_INCLUDED
...
namespace cohen
{
    using engine::magic::MagicBishopMask;
    using engine::magic::MagicBishopAttacks;
    using engine::magic::MagicRookMask;
    using engine::magic::MagicRookAttacks;
    using engine::magic::MagicQueenAttacks;
}
