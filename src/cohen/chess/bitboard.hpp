#ifndef COHEN_CHESS_BITBOARD_HPP_INCLUDED
#define COHEN_CHESS_BITBOARD_HPP_INCLUDED
...
namespace cohen::chess::bitboard
{
...
{
    using cohen::chess::bitboard::Bitboard;

    using cohen::chess::bitboard::kEmptyBB;
    using cohen::chess::bitboard::kUniverseBB;
    using cohen::chess::bitboard::kDarkSquaresBB;
    using cohen::chess::bitboard::kLightSquaresBB;
    using cohen::chess::bitboard::kRankEdgesBB;
    using cohen::chess::bitboard::kFileEdgesBB;
    using cohen::chess::bitboard::kMainDiagBB;
    using cohen::chess::bitboard::kMainAntiBB;
    using cohen::chess::bitboard::kEdgesBB;

    using cohen::chess::bitboard::SquareBB;
    using cohen::chess::bitboard::RankBB;
    using cohen::chess::bitboard::FileBB;
    using cohen::chess::bitboard::DiagBB;
    using cohen::chess::bitboard::AntiBB;
    using cohen::chess::bitboard::RayBB;
    using cohen::chess::bitboard::BetweenBB;
    using cohen::chess::bitboard::ShiftBB;
    using cohen::chess::bitboard::MirrorBitboardRank;
    using cohen::chess::bitboard::MirrorBitboardFile;
    using cohen::chess::bitboard::MirrorBitboardDiag;
    using cohen::chess::bitboard::MirrorBitboardAnti;
}
